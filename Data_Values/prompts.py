prompts = {
    ...
    "2": f"""I want to generate  'نظمیں' about '{{poetry_topic}}' in Urdu text. Each Poetry seperated by new line. Number of poems should be between 2 and 3 and each containing 4 sentences or more. Strictly there should be no English. The format should be in following  format:
