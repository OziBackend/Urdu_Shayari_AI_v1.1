        ...
        try:
            completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": prompt_1.format(poet_name=data['poet_name'], poem_name=data['poem_name']),
                    },
                ],
            )
            ...
            return {
                "flag": True, 
                "completion_data": completed_data
            }
        ...
        try:
            completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": prompt_3.format(poetry_category=data['poetry_category']),
                    },
                ],
            )
            completed_data = completion.choices[0].message.content
